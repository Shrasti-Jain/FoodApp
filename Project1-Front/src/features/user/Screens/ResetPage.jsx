...
const ResetPage = () => {
  ...
  let handleSubmit = async (e) => {
    try {
      ...
      let res = await axiosInstance.post(`/api/auth/reset/${token}`, data);
      ...
      <div className="relative w-full max-w-md">
        <div className="bg-[#101522] border border-white/8 rounded-[32px] p-8 shadow-[0_0_24px_rgba(78,161,255,0.08)] backdrop-blur-xl">
          <div className="flex justify-center mb-6">
            <div className="w-20 h-20 rounded-full bg-[#4ea1ff]/10 border border-[#4ea1ff]/20 flex items-center justify-center shadow-[0_0_24px_rgba(78,161,255,0.18)]">
